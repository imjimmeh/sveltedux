...
import { isPending, isFulfilled } from "../async.js";
...
export function createCacheMiddleware<TState = any>(
  ...
  const handlePendingAction = (action: Action, dispatch: (action: Action) => unknown): Action => {
